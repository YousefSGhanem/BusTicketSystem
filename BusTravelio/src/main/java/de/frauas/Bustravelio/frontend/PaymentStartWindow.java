 ...
 * @author haith
 */
public class PaymentStartWindow extends javax.swing.JFrame {
    String username2;
    /**
     * Creates new form PaymentStartWindow
     */
    public PaymentStartWindow() {
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("Welcome To TravelioCoin Payment Menu");
        ...
        kGradientPanel1.add(infoLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 710, 620, -1));

        labelfrom.setFont(new java.awt.Font("Avenir Next", 0, 48)); // NOI18N
        labelfrom.setText("BusTravelio ");
        kGradientPanel1.add(labelfrom, new org.netbeans.lib.awtextra.AbsoluteConstraints(640, 820, 270, -1));
        ...
        kGradientPanel1.add(changingLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 570, 880, 30));
        ...
        kGradientPanel1.add(sendLuxcoinLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 450, 680, -1));
        ...
        kGradientPanel1.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 420, 620, -1));
        ...
        kGradientPanel1.add(giveCodeLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 330, 540, -1));
        ...
        kGradientPanel1.add(showStoryLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 270, 450, -1));
        ...
        kGradientPanel1.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(1040, 330, -1, -1));
        ...
        kGradientPanel1.add(closeButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(1290, 20, 140, 40));
        ...
        kGradientPanel1.add(showStryButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(760, 270, 140, 40));
        ...
        kGradientPanel1.add(giveCodeButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(760, 320, 140, 40));
        ...
        kGradientPanel1.add(sendLuxcoinButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(760, 440, 200, 40));

        SetCoinLabel.setFont(new java.awt.Font("Avenir Next", 1, 36)); // NOI18N
        SetCoinLabel.setForeground(new java.awt.Color(242, 242, 242));
        kGradientPanel1.add(SetCoinLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(1230, 310, 240, 70));

        welcomeUSERLabel.setFont(new java.awt.Font("Avenir Next", 1, 24)); // NOI18N
        welcomeUSERLabel.setForeground(new java.awt.Color(242, 242, 242));
        welcomeUSERLabel.setText("welcome Username Luxpayment ");
        kGradientPanel1.add(welcomeUSERLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 30, -1, 25));

        fromDatabaseLabel.setFont(new java.awt.Font("Avenir Next", 1, 24)); // NOI18N
        fromDatabaseLabel.setForeground(new java.awt.Color(242, 242, 242));
        kGradientPanel1.add(fromDatabaseLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(860, 30, 190, -1));
    ...
    public void Setcurrentamount(String username2) {
        ...
        try {
            ...
            Logger.getLogger(PaymentStartWindow.class.getName()).log(Level.SEVERE, null, ex);
        }
